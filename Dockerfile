...
RUN apt update && apt install -y libapache2-mod-php8.1 php8.1-cli php8.1-mysql php8.1-gd php8.1-bcmath php8.1-mbstring \
    ...
    wget curl locales supervisor logrotate
